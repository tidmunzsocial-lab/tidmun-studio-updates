...
$originalVersionJson = [System.IO.File]::ReadAllText($versionPath)
...
try {
    ...
    if (-not $published) {
        [System.IO.File]::WriteAllText($versionPath, $originalVersionJson, (New-Object System.Text.UTF8Encoding($false)))
    }
}
